...
// implementing using event delegation
...
// whole tabbed components comes under operations

tabsContainer.addEventListener('click', function(e) {
  const clicked = e.target.closest('.operations__tab')
  // doing this because button has two things a button and a span i.e, a number (01, 02, 03)
